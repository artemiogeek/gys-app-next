 ...
 */
// 📊 Función específica para calcular estadísticas Master
export const calculateMasterStats = (items: ListaEquipoItem[]): ListaEquipoMaster['stats'] => {
  const stats: ListaEquipoMaster['stats'] = {
...
// 📊 Función genérica para calcular estadísticas (Master o Detail)
export const calculateStats: StatsCalculator = (items: ListaEquipoItem[]) => {
  return calculateMasterStats(items);
};
