...
interface Props {
  ...
  showActions?: boolean // ✅ Controlar si mostrar botones de acción
  expanded?: boolean // ✅ Controlar si está expandido por defecto
}
...
export default function CotizacionProveedorAccordion({
  ...
  return (
    <div className="animate-fade-in">
      {/* ✅ Using CSS animation instead of framer-motion to avoid JSX parsing issues */}
      <Card className="w-full shadow-md hover:shadow-lg transition-shadow duration-200 border-l-4 border-l-blue-500">
        <Accordion 
          type="single" 
          collapsible={!expanded} 
          className="w-full"
          defaultValue={expanded ? cotizacionData.id : undefined}
        >
