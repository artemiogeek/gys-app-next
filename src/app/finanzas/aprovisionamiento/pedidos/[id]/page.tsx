          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Proyecto: {pedido.proyecto?.nombre || 'Sin proyecto asignado'}
              </p>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <Avatar className="h-12 w-12">
                      <AvatarFallback>
                        {pedido.proyecto.nombre.substring(0, 2).toUpperCase()}
                      </AvatarFallback>
                    </Avatar>
                    <div>
                      <p className="font-medium">{pedido.proyecto.nombre}</p>
                      <p className="text-sm text-muted-foreground">{pedido.proyecto.codigo}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm">{pedido.proyecto.cliente || 'No disponible'}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <MapPin className="h-4 w-4 text-muted-foreground" />
                      <span className="text-sm">{pedido.proyecto.ubicacion || 'No disponible'}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Building className="h-4 w-4 text-muted-foreground" />
                      <span className="text-sm">{pedido.proyecto.descripcion || 'No disponible'}</span>
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3 pb-4 border-b">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">Por: {pedido.usuario?.nombre || 'Sistema'}</p>
